...
export type AcaoAuditoria =
  ...
  | 'MANAGER_ALERT_RESOLVED'
  | 'MANAGER_ALERT_DISMISSED'
  | 'ACTION_PLAN_CREATED'
  | 'ACTION_PLAN_UPDATED'
  ...
  | 'FOLLOWUP_DONE'
  | 'FOLLOWUP_DISMISSED'
  | 'MANAGER_RECOGNITION_SUGGESTED'
  | 'TRAINING_ASSIGNED_BY_MANAGER'
  | 'MISSION_ASSIGNED_BY_MANAGER'
